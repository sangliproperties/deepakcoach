...
import type { AvailabilitySlot, Booking, CancellationPolicy, Review, Testimonial, YouTubeSession } from "@/lib/types";
...
export default function AdminConsole() {
  ...
  const nav = [["overview", "Overview"], ["users", `Users (${operations.users.length})`], ["catalog", "Programs"], ["content", "Content"], ["bookings", "Bookings & payments"], ["reviews", "Reviews & testimonials"], ["audit", "Activity log"], ["policy", "Policies"]];
