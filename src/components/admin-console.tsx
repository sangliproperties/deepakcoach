...
import type { AvailabilitySlot, Booking, CancellationPolicy, Review, Testimonial } from "@/lib/types";
...
export default function AdminConsole() {
  ...
  const nav = [["overview", "Overview"], ["users", `Users (${operations.users.length})`], ["catalog", "Programs"], ["bookings", "Bookings & payments"], ["reviews", "Reviews & testimonials"], ["policy", "Policies"]];
